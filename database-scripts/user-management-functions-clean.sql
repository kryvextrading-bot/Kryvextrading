-- ========================================
-- User Management Functions (Production Ready - Clean Version)
-- ========================================
...
BEGIN
    ...
    PERFORM log_admin_action(p_user_id, 'password_reset', 
        'Password reset requested for ' || v_user_email,
        p_admin_id
    );
...
-- Step 2: psql -d your_database -f user-management-functions-clean.sql
