-- Simple script to fix trade_outcomes table for LOSS by default behavior
...
-- Create the trade_outcomes table with the correct structure (no expires_at)
...
-- Create a view to see active outcomes
...
-- Sample data for testing (replace USER_UUID_HERE with actual user UUID)
-- Force WIN for a specific user
...
-- Force LOSS for a specific user
INSERT INTO public.trade_outcomes (
    user_id,
    enabled,
    outcome_type,
